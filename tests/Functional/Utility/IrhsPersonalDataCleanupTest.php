...
class IrhsPersonalDataCleanupTest extends AbstractPersonalDataCleanupTest
{
    public function dataCleanup(): array
    {
        return [
            ...
            ['2021-01-01 00:00:00', '2019-12-31 00:00:00', false, true],  // Q4 2019 should be deleted
            ['2021-01-01 00:00:00', '2020-01-01 00:00:00', false, false], // Q1 2020 should NOT be deleted

            // Q1 2021 -> Q1 2020
            //   Testing boundary of Q1 2021
            ['2021-01-01 00:00:00', '2019-10-01 00:00:00', false, true],  // This is Q1 2021, so Q4 2019 should be deleted
            ['2020-12-31 00:00:00', '2019-10-01 00:00:00', false, false], // This is Q4 2020, so Q4 2019 should NOT be deleted
            ...
            ['2021-01-01 00:00:00', '2019-12-31 00:00:00', true, false],
            ['2021-01-01 00:00:00', '2020-01-01 00:00:00', true, false],
