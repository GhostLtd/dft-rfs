...
#[ORM\Table(name: 'route_uk_port')]
#[ORM\Entity(repositoryClass: UkPortRepository::class)]
class UkPort implements PortInterface
{
    use IdTrait;
     ...
     */
    #[ORM\OneToMany(mappedBy: 'ukPort', targetEntity: Route::class)]
    ...
    public function removeRoute(Route $route): self
    {
        if ($this->routes->removeElement($route)) {
            ...
            if ($route->getUkPort() === $this) {
                $route->setUkPort(null);
            }
        }
