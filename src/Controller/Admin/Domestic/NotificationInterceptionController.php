...
/**
 * @Route("/csrgt/notification-interception", name="admin_domestic_notification_interception_")
 */
class NotificationInterceptionController extends AbstractController
{
    ...
    public function list(NotificationInterceptionListPage $listPage, Request $request): Response
    {
        ...
        return $this->render('admin/notification_interception/list.html.twig', [
            ...
            'edit_route' => 'admin_domestic_notification_interception_edit',
     ...
     * @Route("/add", name="add")
     */
    public function edit(Request $request, ?NotificationInterception $notificationInterception = null): Response
    {
